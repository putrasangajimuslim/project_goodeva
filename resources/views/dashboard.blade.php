...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Project Base</h3>

                            <a href="{{ url('/project/export') }}" target="_blank" class="btn btn-success text-white">Download xls</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <canvas id="myPieChart3" width="300" height="300"></canvas>
                                </div>
                                <div class="col-md-6">
                                    <canvas id="myPieChart4" width="300" height="300"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        async function fetchDataGaris() {
            const response = await fetch('/chart/garis');
            const data = await response.json();
            return data;
        }

        async function createChartPie() {
        ...
        async function createChartRpm() {
            const data = await fetchData();
            
            const labels = data.rpm.map(item => item.time);
            const values = data.rpm.map(item => item.rpm);
        ...
        async function createChartBulat() {
            const data = await fetchData();
            
            const labels = data.bulat.map(item => item.category);
            const values = data.bulat.map(item => item.total);
        ...
        async function createChartGaris() {
            const data = await fetchDataGaris();
